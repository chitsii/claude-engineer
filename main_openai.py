...
# System prompt
system_prompt = """
You are an AI assistant powered by OpenAI's GPT model. You are an exceptional software developer with vast knowledge across multiple programming languages, frameworks, and best practices. Your capabilities include:
...
def chat_with_claude(user_input, image_path=None, current_iteration=None, max_iterations=None):
    ...
    if hasattr(message, 'function_call') and message.function_call:
        ...
        conversation_history.append({"role": "assistant", "content": None, "function_call": message.function_call})
